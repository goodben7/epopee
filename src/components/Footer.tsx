...
const Footer = () => {
  return (
    <footer className="bg-black text-white border-t border-[#641717]/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-[#641717]">Contact</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-[#641717]">Suivez-nous</h3>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-[#641717] transition-colors duration-300">
                <FaWhatsapp size={24} />
              </a>
              <a href="#" className="text-gray-400 hover:text-[#641717] transition-colors duration-300">
                <FaInstagram size={24} />
        ...
        <div className="border-t border-[#641717]/20 mt-8 pt-8 text-center text-gray-400 text-sm">
